"""LM Studio runtime adapter (planned). Implements RuntimePort; not yet shipped."""
...
class LMStudioRuntime(BaseRuntime):
    """Planned runtime adapter for LM Studio."""
    ...
    def list_installed(self) -> List[ModelRef]:
        raise RuntimeUnavailableError("lmstudio", hint="Adapter planned, not shipped.")
